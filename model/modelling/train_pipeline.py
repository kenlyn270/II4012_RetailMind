...
# Paths
RFM_PATH = 'model/modelling/rfm_customer_table.csv'
TRANSACTIONS_PATH = 'model/data/clean_transactions.csv'
MODEL_EXPORT_PATH = 'model/model/retail_ai_model_assets.joblib'
